...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'first_name'        => 'required',
            'last_name'         => 'required',
            'document'          => 'required|numeric|digits:10|unique:pruebas,document,'.$user_id,
            'email'             => 'required|email|unique:pruebas,email,'.$user_id,
    ...
    public function messages()
    {
        return [
            ...
            'document.required'         => 'El :attribute es obligarotio.',
            'document.numeric'          => 'El :attribute debe ser un tipo numérico',
            'document.digits'           => 'El :attribute no debe tener menos ni pasar de 10 números',
            ...
            'phone.digits'              => 'La :attribute no debe tener menos ni pasar de 9 números.',
